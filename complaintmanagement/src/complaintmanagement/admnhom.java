...
public class admnhom extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ImageIcon img=new ImageIcon(getClass().getResource("/Images/3.jpg"));
        ...
        jMenuItem4.setText("Register Complaints");
   ...
   frmact object;
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        if(object==null||object.isClosed()==true)
        {
            object=new frmact();
            jDesktopPane1.add(object);
